...
import com.example.glidedemo.views.flowlayout.TagAdapter.OnDataChangedListener
...
class TagFlowLayout @JvmOverloads constructor(
    ...
    fun addAdapter(adapter: TagAdapter<Any>?) {
    ...
    private fun changeAdapter() {
        ...
        val preCheckedList: HashSet<Int> = adapter!!.preCheckedList
